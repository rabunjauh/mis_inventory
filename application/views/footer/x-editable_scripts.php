<link href="<?=base_url('assets/X-editable/css/bootstrap-editable.css') ?>" rel="stylesheet" media="screen">
<script src="<?=base_url('assets/X-editable/js/bootstrap-editable.min.js') ?>"></script>
