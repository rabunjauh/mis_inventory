                ...
                <div class="tab-pane active" id="all_items">
                    ...
                    <div class="form-group">
                        ...
                        <select name="select_filter" id="select_filter" class="form-control" required>
                            ...
                            <option value="Operating System">Category</option>
...
// let html = '';
// for (let i = 0; i < data.length; i++) { // html +='<option value=' + data[i].idposition + '>' + data[i].positiondesc + '</option>' ; // } // $('#dropdownDesignation').html(html); // } // }); // return false; // }); <label class="radio-inline"><?= form_radio('radioEmployeeStatus', '1', TRUE); ?>New Staff</label>
