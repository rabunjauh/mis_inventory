    ...
    if ($this->input->post()) {
      ...
      if ($this->form_validation->run() != FALSE) {
        ...
        if ($form_info['item_material_status'] == 1) {
          ...
          $form_info['machine_type'] = $this->input->post('machine_type_id', TRUE);
          $form_info['model'] = $this->input->post('model', TRUE);
          $form_info['model'] = $this->input->post('model_id', TRUE);
          $form_info['operating_system'] = $this->input->post('operating_system', TRUE);
          $form_info['operating_system'] = $this->input->post('operating_system_id', TRUE);
          $form_info['processor'] = $this->input->post('processor', TRUE);
          $form_info['processor'] = $this->input->post('processor_id', TRUE);
          $form_info['memory'] = $this->input->post('memory', TRUE);
          $form_info['memory'] = $this->input->post('memory_id', TRUE);
          $form_info['hdd'] = $this->input->post('hdd', TRUE);
          $form_info['harddisk'] = $this->input->post('harddisk_id', TRUE);
          $form_info['vga'] = $this->input->post('vga', TRUE);
          $form_info['vga'] = $this->input->post('vga_id', TRUE);
